...
class RiskManager:
    ...
    def _create_smart_zone(self, row, prev_row, is_uptrend, is_downtrend):
        ...
        # El backtester V224 ya tiene la lógica de impulso estricta (2.5x)
        ...
        async with self.bot.lock:
            ...
            for z in self.state.active_zones:
                ...
                if is_uptrend and z['type'] == 'DEMAND':
                    ...
                    # FIX V224: Confirmación con Desplazamiento
                    ...
                    if touched and swept and confirmed:
                        ...
                        if dist_to_struct > (atr * 6.0):
                            take_profit = tp_min_rr # Estructura muy lejos, vamos a lo seguro
                        else:
                        ...
                        if risk > 0 and (reward / risk) >= self.min_rr:
                            best_setup = (SIDE_BUY, current_price, stop_loss, take_profit, "SMC Demand V224", z)
                ...
                # --- SUPPLY SETUP (SHORT) ---
                    ...
                    if touched and swept and confirmed:
                        ...
                        if risk > 0 and (reward / risk) >= self.min_rr:
                            best_setup = (SIDE_SELL, current_price, stop_loss, take_profit, "SMC Supply V224", z)
            ...
            if best_setup:
                ...
                if qty > 0:
                    ...
                    logging.info(f"!!! SIGNAL V224 !!! {label} | R/R: {rr_calc:.2f}")

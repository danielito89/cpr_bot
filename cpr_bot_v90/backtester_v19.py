#!/usr/bin/env python3
# backtester_v19.py
# NIVEL: V219 (Support for Micro-Failure Logic)
...
class BacktesterV19:
    ...
    def load_data(self):
        ...
        try:
            ...
            # NUEVO V219: Pre-calculate Previous High/Low for Micro-failure check
    ...
    async def run(self):
        ...
        print(f"\n🛡️ INICIANDO BACKTEST V219 (Improved Range)")
        ...
        for current_time, row in df.iterrows():
            ...
            if not self.state.is_in_position and not self.state.pending_order:
                # PASAMOS prev_high y prev_low en kline para V219
                kline = {
    ...
    def generate_report(self):
        ...
        print("\n" + "="*60)
        print(f"📊 REPORTE PROFESIONAL (V219) - {self.symbol}")
        print("="*60)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CPR Bot Backtester V219")
